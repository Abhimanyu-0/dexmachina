python dexmachina/rl/train_rl_games.py -B 512  -obf -obt --max_epochs 1500 \
  ...
  --task_rew_betas 10 1 5 --use_retarget_contact --aux_reset_thres 0 0 0 \
  --curr_rew_thres 0.6 0.01 0.01 0.01 -am hybrid --hybrid_scales 0.1 1.0 \
  --kp_init 80 --kv_init 5 --clip laptop-30-230-s01-u01 -imi 0.3 -bc 0.3 \
  -con 3 -ert 0.6 -exp laptop_full --hand xhand
